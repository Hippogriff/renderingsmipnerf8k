...
export function wasm_bindgen__convert__closures__invoke1_mut__h1e5ffb161d4df17d(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hfec377200c84574b(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h2fd241ce48afee58(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h9351c5f0eedfaff7(a: number, b: number, c: number): void;
